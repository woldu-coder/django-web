...
class Hotel(models.Model):
	# food_type = models.ForeignKey(Recommended, on_delete=models.SET_NULL, null=True, blank=True)
	...
	image 			= models.ImageField(default="hotel.png", upload_to="hotels", null=True, blank=True)
